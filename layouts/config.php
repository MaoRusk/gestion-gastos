...
if (DB_TYPE === 'sqlite' && extension_loaded('pdo_sqlite')) {
    ...
    die("ERROR: No database extensions available. Please install php-sqlite3, php-mysqli, or php-pdo_mysql");
}
...
if (!extension_loaded('mysqli') && (extension_loaded('pdo_mysql') || extension_loaded('pdo_sqlite'))) {
