-- ============================================================================
-- BASE DE DATOS COMPLETA PARA MARIA DB
...
-- Marzo 2025 - Ingresos
(1, 1, 1, 'Salario mensual', 8000.00, 'gasto', '2025-03-15', NULL),
...
(3, 7, 7, 0.00, 'Depósito cheque', '2025-02-15'); -- No hay cuenta destino real, solo ejemplo
