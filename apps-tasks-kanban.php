                ...
                <div class="row">
                    ...
                    <div class="tasks-board mb-3" id="kanbanboard">
                        <div class="tasks-list">
                            <div class="d-flex mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 text-uppercase fw-bold mb-0">Unassigned <small
                                ...
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown"
                                            ...
                                            <span class="fw-medium text-muted fs-14">Priority<i
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <h6 class="fs-16 mb-0 flex-grow-1 text-truncate task-title"><a
                                                        href="apps-tasks-details.php" class="link-dark d-block">Profile Page
                                                        Satructure</a></h6>
                                                <div class="dropdown">
                                            ...
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-16 mb-0 text-truncate task-title"><a
                                                            href="apps-tasks-details.php" class="link-dark d-block">Velzon -
                        ...
                        <div class="tasks-list">
                            <div class="d-flex mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 text-uppercase fw-bold mb-0">To Do <small
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-16 mb-0 text-truncate task-title"><a
                                                            href="apps-tasks-details.php" class="link-dark d-block">Admin
                                                            Layout Design</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <a href="javascript:void(0);" class="text-muted"
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-16 mb-0 text-truncate task-title"><a
                                                            href="apps-tasks-details.php" class="link-dark d-block">Marketing &
                                                            Sales</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <a href="javascript:void(0);" class="text-muted"
                        ...
                        <div class="tasks-list">
                            <div class="d-flex mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 text-uppercase fw-bold mb-0">Inprogress <small
                                ...
                                <div id="inprogress-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details.php"
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details.php"
                                                    class="link-dark d-block">Change Old App Icon</a></h6>
                        ...
                        <div class="tasks-list">
                            <div class="d-flex mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 text-uppercase fw-bold mb-0">In Reviews <small
                                ...
                                <div id="reviews-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details.php"
                                                    class="link-dark d-block">Create Product Animations</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details.php"
                                                    class="link-dark d-block">Product Features Analysis</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details.php"
                                                    class="link-dark d-block">Create a Graph of Sketch</a></h6>
                        ...
                        <div class="tasks-list">
                            <div class="d-flex mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 text-uppercase fw-bold mb-0">Completed <small
                                ...
                                <div id="completed-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <h6 class="fs-16 mb-0 flex-grow-1 text-truncate task-title"><a
                                                        href="apps-tasks-details.php" class="link-dark d-block">Create a Blog
                                                        Template UI</a></h6>
                                                <div class="dropdown">
                                                    <a href="javascript:void(0);" class="text-muted"
                        ...
                        <div class="tasks-list">
                            <div class="d-flex mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 text-uppercase fw-bold mb-0">new <small
                                            class="badge bg-success align-bottom ms-1 totaltask-badge">1</small></h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                ...
                                <div id="new-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details.php"
                                                    class="link-dark d-block">Banner Design for FB & Twitter</a></h6>
                                            <div class="tasks-img rounded"
